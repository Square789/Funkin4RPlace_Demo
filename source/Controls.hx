...
{
	// @Square789: Making just these public cause i'm a massive cheapskate and others
	// are not really needed for the HoldTimer.
	public var ui_up = new FlxActionDigital(Action.UI_UP);
	public var ui_left = new FlxActionDigital(Action.UI_LEFT);
	public var ui_right = new FlxActionDigital(Action.UI_RIGHT);
	public var ui_down = new FlxActionDigital(Action.UI_DOWN);
	public var ui_upP = new FlxActionDigital(Action.UI_UP_P);
	public var ui_leftP = new FlxActionDigital(Action.UI_LEFT_P);
	public var ui_rightP = new FlxActionDigital(Action.UI_RIGHT_P);
	public var ui_downP = new FlxActionDigital(Action.UI_DOWN_P);
	public var ui_upR = new FlxActionDigital(Action.UI_UP_R);
	public var ui_leftR = new FlxActionDigital(Action.UI_LEFT_R);
	public var ui_rightR = new FlxActionDigital(Action.UI_RIGHT_R);
	public var ui_downR = new FlxActionDigital(Action.UI_DOWN_R);
	var note_up = new FlxActionDigital(Action.NOTE_UP);
	var note_left = new FlxActionDigital(Action.NOTE_LEFT);
	var note_right = new FlxActionDigital(Action.NOTE_RIGHT);
	var note_down = new FlxActionDigital(Action.NOTE_DOWN);
	var note_upP = new FlxActionDigital(Action.NOTE_UP_P);
	var note_leftP = new FlxActionDigital(Action.NOTE_LEFT_P);
	var note_rightP = new FlxActionDigital(Action.NOTE_RIGHT_P);
	var note_downP = new FlxActionDigital(Action.NOTE_DOWN_P);
	var note_upR = new FlxActionDigital(Action.NOTE_UP_R);
	var note_leftR = new FlxActionDigital(Action.NOTE_LEFT_R);
	var note_rightR = new FlxActionDigital(Action.NOTE_RIGHT_R);
	var note_downR = new FlxActionDigital(Action.NOTE_DOWN_R);
	var accept = new FlxActionDigital(Action.ACCEPT);
	var back = new FlxActionDigital(Action.BACK);
	var pause = new FlxActionDigital(Action.PAUSE);
	var reset = new FlxActionDigital(Action.RESET);
	...
	inline function get_UI_LEFT_P()
		return ui_leftP.check();

	public var UI_RIGHT_P(get, never):Bool;

	inline function get_UI_RIGHT_P()
		return ui_rightP.check();

	public var UI_DOWN_P(get, never):Bool;

	inline function get_UI_DOWN_P()
		return ui_downP.check();
	...
	inline function get_UI_LEFT_R()
		return ui_leftR.check();

	public var UI_RIGHT_R(get, never):Bool;

	inline function get_UI_RIGHT_R()
		return ui_rightR.check();

	public var UI_DOWN_R(get, never):Bool;

	inline function get_UI_DOWN_R()
		return ui_downR.check();
	...
	inline function get_NOTE_UP_P()
		return note_upP.check();

	public var NOTE_LEFT_P(get, never):Bool;

	inline function get_NOTE_LEFT_P()
		return note_leftP.check();

	public var NOTE_RIGHT_P(get, never):Bool;

	inline function get_NOTE_RIGHT_P()
		return note_rightP.check();

	public var NOTE_DOWN_P(get, never):Bool;

	inline function get_NOTE_DOWN_P()
		return note_downP.check();

	public var NOTE_UP_R(get, never):Bool;

	inline function get_NOTE_UP_R()
		return note_upR.check();

	public var NOTE_LEFT_R(get, never):Bool;

	inline function get_NOTE_LEFT_R()
		return note_leftR.check();

	public var NOTE_RIGHT_R(get, never):Bool;

	inline function get_NOTE_RIGHT_R()
		return note_rightR.check();

	public var NOTE_DOWN_R(get, never):Bool;

	inline function get_NOTE_DOWN_R()
		return note_downR.check();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			case UI_UP:
				func(ui_up, PRESSED);
				func(ui_upP, JUST_PRESSED);
				func(ui_upR, JUST_RELEASED);
			case UI_LEFT:
				func(ui_left, PRESSED);
				func(ui_leftP, JUST_PRESSED);
				func(ui_leftR, JUST_RELEASED);
			case UI_RIGHT:
				func(ui_right, PRESSED);
				func(ui_rightP, JUST_PRESSED);
				func(ui_rightR, JUST_RELEASED);
			case UI_DOWN:
				func(ui_down, PRESSED);
				func(ui_downP, JUST_PRESSED);
				func(ui_downR, JUST_RELEASED);
			case NOTE_UP:
				func(note_up, PRESSED);
				func(note_upP, JUST_PRESSED);
				func(note_upR, JUST_RELEASED);
			case NOTE_LEFT:
				func(note_left, PRESSED);
				func(note_leftP, JUST_PRESSED);
				func(note_leftR, JUST_RELEASED);
			case NOTE_RIGHT:
				func(note_right, PRESSED);
				func(note_rightP, JUST_PRESSED);
				func(note_rightR, JUST_RELEASED);
			case NOTE_DOWN:
				func(note_down, PRESSED);
				func(note_downP, JUST_PRESSED);
				func(note_downR, JUST_RELEASED);
			case ACCEPT:
	...
	public function getFirstFormattedInputName(control:Control):String {
		// gamepad??? man i just want a button name, so those are ignored
		var inputs = getInputsFor(control, Keys);
		if (inputs.length == 0) {
			return "---";
		}
		return InputFormatter.getInputName(inputs[0]);
	}

	public function getFormattedInputNames(control:Control, separator:String = "/"):String {
		var inputs = getInputsFor(control, Keys);
		if (inputs.length == 0) {
			return "<not bound>";
		}
		return [for (i in inputs) InputFormatter.getInputName(i)].join(separator);
	}
}
