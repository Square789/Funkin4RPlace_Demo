...
// @Square789: Code regretlessly copypasted from Psych-Engine main branch at... checks notes...
// commit f312b35b8e5dd8592f96c09b44023e78fbfc1258.
// Shoutouts to HaxeFlixel for straight-up not being able to load shaders from strings normally.
...
class RuntimeShader extends FlxShader
{
	...
	static final BASE_VERTEX_HEADER:String = #if !html5 "
		#pragma version
		" + #end "
		#pragma precision
	...
	static final BASE_FRAGMENT_HEADER:String = #if !html5 "
		#pragma version
		" + #end "
